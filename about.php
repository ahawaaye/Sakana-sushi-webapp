...
<section class="section-about">
    ...
    <p>
        ...
        Wij serveren traditionele Japanse gerechten met een moderne twist,
        gemaakt met dagverse ingrediënten en een passie voor perfectie.
    </p>
</section>

<section class="content-block">
    <img class="image_kawaii_sushi" src="images/kawaii_sushi.jpg" alt="Sushi op tafel"> 
    <div class="text-box">
        <p>
        ...
        <a class="button-about" href="index.php">Bekijk ons menu</a>
    </div>
</section>
